...
import sty from "./PlasmicButton.module.css"; // plasmic-import: r98mWgbU1oG5dP/css
import MenuIcon from "./icons/PlasmicIcon__Menu"; // plasmic-import: 5qfKdLmjnYwsf8/icon
  ...
  return (
    ...
    >
      {(
        ...
        <div
          className={classNames(projectcss.all, sty.freeBox__vzDMw, {
            [sty.freeBoxiconOnly__vzDMw1Twtd]: hasVariant(
              $state,
              "iconOnly",
              "iconOnly"
            ),

            [sty.freeBoxshowEndIcon__vzDMwagM3T]: hasVariant(
              $state,
              "showEndIcon",
              "showEndIcon"
            ),

            [sty.freeBoxshowStartIcon__vzDMwzx74B]: hasVariant(
              $state,
              "showStartIcon",
              "showStartIcon"
            ),

            [sty.freeBoxsize_large__vzDMwownA]: hasVariant(
              $state,
              "size",
              "large"
            ),

            [sty.freeBoxsize_small__vzDMwVXpwY]: hasVariant(
              $state,
              "size",
              "small"
            )
        ...
        >
          {(hasVariant($state, "showEndIcon", "showEndIcon") ? true : true)
            ? p.renderPlasmicSlot({
                defaultContents: (
                  <MenuIcon
                    className={classNames(projectcss.all, sty.svg__tTlPy)}
                    role={"img"}
                  />
                ),
      ...
      {(hasVariant($state, "showEndIcon", "showEndIcon") ? true : false) ? (
        <div
          className={classNames(projectcss.all, sty.freeBox__kDc03, {
            [sty.freeBoxshowEndIcon__kDc03AgM3T]: hasVariant(
              $state,
              "showEndIcon",
              "showEndIcon"
            ),

            [sty.freeBoxsize_small__kDc03VXpwY]: hasVariant(
              $state,
              "size",
              "small"
            )
        ...
        >
          {(hasVariant($state, "showEndIcon", "showEndIcon") ? true : false)
            ? p.renderPlasmicSlot({
                defaultContents: (
                  <MenuIcon
                    className={classNames(projectcss.all, sty.svg__j2Sl6)}
                    role={"img"}
                  />
                ),
