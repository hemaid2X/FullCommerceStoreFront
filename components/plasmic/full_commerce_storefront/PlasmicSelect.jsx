...
import Select__Overlay from "../../Select__Overlay"; // plasmic-import: mHcUz-u_w2JHWJ/component
import Select__Option from "../../Select__Option"; // plasmic-import: 1fYVQiHanAtZow/component
import Select__OptionGroup from "../../Select__OptionGroup"; // plasmic-import: HJN04o1AjNpvnw/component
...
import sty from "./PlasmicSelect.module.css"; // plasmic-import: ekR2JNdKDxMto_/css
import ChevronDownIcon from "./icons/PlasmicIcon__ChevronDown"; // plasmic-import: v3K33EPdotBfWm/icon
import ChevronUpsvgIcon from "./icons/PlasmicIcon__ChevronUpsvg"; // plasmic-import: 1kak3Yr-J-rrUL/icon
              ...
              {p.renderPlasmicSlot({
                defaultContents: (
                  <React.Fragment>
                    ...
                    <Select__Option
                      className={classNames("__wab_instance", sty.option__zYs1)}
                      value={"value2"}
                    >
                      {"Option 2"}
                    </Select__Option>
    ...
    if (!("children" in props)) {
      props = {
        ...
        children: (
          <React.Fragment>
            <Select__Option
              className={classNames("__wab_instance", sty.option__wWIcE)}
              value={"value1"}
            >
              {"Option 1"}
            </Select__Option>
