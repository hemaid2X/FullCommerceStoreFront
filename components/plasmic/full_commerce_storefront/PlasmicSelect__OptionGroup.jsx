...
import sty from "./PlasmicSelect__OptionGroup.module.css"; // plasmic-import: HJN04o1AjNpvnw/css
import SUPER__PlasmicSelect from "./PlasmicSelect"; // plasmic-import: ekR2JNdKDxMto_/render
      ...
      >
        {p.renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              <Select__Option
                className={classNames("__wab_instance", sty.option__rhMbp)}
              />

              <Select__Option
                className={classNames("__wab_instance", sty.option__xQzpm)}
              />
            </React.Fragment>
          ),
